...
# Set dir
DroneStatusDir = './ModelFiles/remove1drone.txt'
TaskConfigurationDir = './ModelFiles/remove1tasks.txt'
PrismDir = './libs/prism-4.7-linux64/bin/prism'
PrismModelDir = './PrismModel'
PrismOutputDir = './ModelFiles/remove1results.txt'
...
NewModel = open(PrismModelDir + '/remove1_model.txt', 'w')
for line in lines:
...
# Create the command
cmd = PrismDir + ' ' + PrismModelDir + '/remove1_model.pm' + ' ' + PrismModelDir + '/property.pctl' \

...
# Set dir
DroneStatusDir = './'+webRef+'/ModelFiles/currentDrones.txt'
TaskConfigurationDir = './'+webRef+'/ModelFiles/currentTasks.txt'
PrismDir = './libs/prism-4.7-linux64/bin/prism'
PrismModelDir = './'+webRef+'/PrismModel'
PrismOutputDir1 = './'+webRef+'/ModelFiles/currentResults.txt'
PrismOutputDir2 = './'+webRef+'/ModelFiles/currentResults_boundedT.txt'
...
# Create the command
cmd1 = PrismDir + ' ' + PrismModelDir + '/current_model.pm' + ' ' + PrismModelDir + '/property.pctl' \

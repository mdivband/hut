...
module agent0
  ...
  [] (battery0 = 0) & (alive0 = 1) & (place0 != 0) & (drainC0 = 3) -> 4*battery_drain_low_critical : (battery0' = 3) & (charge0' = 1) & (return0' = 1) & (turning0' = 1) & (drainC0' = 0) & (moveC0' = 0);

  // Battery charge at base
  [] (battery0 = 3) & (charge0 = 1) & (alive0 = 1) & (place0 = 0) & (drainC0 = 0) -> 4*battery_charge: (drainC0' = 1);
  [] (battery0 = 3) & (charge0 = 1) & (alive0 = 1) & (place0 = 0) & (drainC0 = 1) -> 4*battery_charge: (drainC0' = 2);
  [] (battery0 = 3) & (charge0 = 1) & (alive0 = 1) & (place0 = 0) & (drainC0 = 2) -> 4*battery_charge: (drainC0' = 3);
  [] (battery0 = 3) & (charge0 = 1) & (alive0 = 1) & (place0 = 0) & (drainC0 = 3) -> 4*battery_charge: (battery0' = 2) & (charge0' = 0) & (drainC0' = 0);
